...
app = FastAPI(
    ...
    title="👾 Flan T5 API",
    summary="Flan T5 API: A question/answer LLM.",
    description="""
                ## Flan T5 API: A question/answer LLM.
    ...
    openapi_tags= [
        {
            "name": "Home",
            "description": "👾 Flan T5 API homepage."
        },
        {
            "name": "Question",
            "description": "👾 Flan T5 API with POST or GET method."
        }
    ]
)
