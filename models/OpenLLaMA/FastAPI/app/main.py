...
app = FastAPI(
    ...
    title="👾 Open llama API",
    summary="Open llama API: A question/answer LLM.",
    description="""
                ## Open llama API: A question/answer LLM.
    ...
    openapi_tags= [
        {
            "name": "Home",
            "description": "👾 Open llama API homepage."
        },
        {
            "name": "Question",
            "description": "👾 Open llama API with POST or GET method."
        }
    ]
)
